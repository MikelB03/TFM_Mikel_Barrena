#[doc = "Register `BUS2ERRSTAT` reader"]
pub type R = crate::R<Bus2errstatSpec>;
...
#[doc = "BUS Error Status Register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`bus2errstat::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Bus2errstatSpec;
impl crate::RegisterSpec for Bus2errstatSpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`bus2errstat::R`](R) reader structure"]
impl crate::Readable for Bus2errstatSpec {}
#[doc = "`reset()` method sets BUS2ERRSTAT to value 0"]
impl crate::Resettable for Bus2errstatSpec {
