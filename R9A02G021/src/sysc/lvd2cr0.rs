...
pub type R = crate::R<Lvd2cr0Spec>;
#[doc = "Register `LVD2CR0` writer"]
pub type W = crate::W<Lvd2cr0Spec>;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Rn {
    #[doc = "0: Negate after a stabilization time (tLVD2) from the time that VCC > Vdet2 is detected"]
    _0 = 0,
    #[doc = "1: Negate after a stabilization time (tLVD2) from the time that LVD2 reset is asserted"]
    _1 = 1,
}
...
impl RnR {
    ...
    #[doc = "Negate after a stabilization time (tLVD2) from the time that VCC > Vdet2 is detected"]
    #[inline(always)]
    pub fn is_0(&self) -> bool {
        *self == Rn::_0
    }
    #[doc = "Negate after a stabilization time (tLVD2) from the time that LVD2 reset is asserted"]
    #[inline(always)]
    pub fn is_1(&self) -> bool {
        *self == Rn::_1
    }
...
impl W {
    #[doc = "Bit 0 - Voltage Monitor 2 Interrupt/Reset Enable"]
    #[inline(always)]
    pub fn rie(&mut self) -> RieW<Lvd2cr0Spec> {
        RieW::new(self, 0)
    }
    #[doc = "Bit 2 - Voltage Monitor 2 Circuit Comparison Result Output Enable"]
    #[inline(always)]
    pub fn cmpe(&mut self) -> CmpeW<Lvd2cr0Spec> {
        CmpeW::new(self, 2)
    }
    #[doc = "Bit 6 - Voltage Monitor 2 Circuit Mode Select"]
    #[inline(always)]
    pub fn ri(&mut self) -> RiW<Lvd2cr0Spec> {
        RiW::new(self, 6)
    }
    #[doc = "Bit 7 - Voltage Monitor 2 Reset Negate Select"]
    #[inline(always)]
    pub fn rn(&mut self) -> RnW<Lvd2cr0Spec> {
        RnW::new(self, 7)
    }
}
#[doc = "Voltage Monitor 2 Circuit Control Register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`lvd2cr0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lvd2cr0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Lvd2cr0Spec;
impl crate::RegisterSpec for Lvd2cr0Spec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`lvd2cr0::R`](R) reader structure"]
impl crate::Readable for Lvd2cr0Spec {}
#[doc = "`write(|w| ..)` method takes [`lvd2cr0::W`](W) writer structure"]
impl crate::Writable for Lvd2cr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets LVD2CR0 to value 0x80"]
impl crate::Resettable for Lvd2cr0Spec {
