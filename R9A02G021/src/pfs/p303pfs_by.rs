#[doc = "Register `P303PFS_BY` reader"]
pub type R = crate::R<P303pfsBySpec>;
#[doc = "Register `P303PFS_BY` writer"]
pub type W = crate::W<P303pfsBySpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P303pfsBySpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P303pfsBySpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P303pfsBySpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open-Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P303pfsBySpec> {
        NcodrW::new(self, 6)
    }
}
#[doc = "Port 303 Pin Function Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p303pfs_by::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p303pfs_by::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P303pfsBySpec;
impl crate::RegisterSpec for P303pfsBySpec {
    type Ux = u8;
}
#[doc = "`read()` method returns [`p303pfs_by::R`](R) reader structure"]
impl crate::Readable for P303pfsBySpec {}
#[doc = "`write(|w| ..)` method takes [`p303pfs_by::W`](W) writer structure"]
impl crate::Writable for P303pfsBySpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u8 = 0;
}
#[doc = "`reset()` method sets P303PFS_BY to value 0x10"]
impl crate::Resettable for P303pfsBySpec {
