...
//{
    ...
    /*if(R_IOPORT_PinRead(&g_ioport_ctrl, BSP_IO_PORT_01_PIN_05, BSP_IO_LEVEL_HIGH)){
        boton = 1;

    } else if (R_IOPORT_PinRead(&g_ioport_ctrl, BSP_IO_PORT_01_PIN_05, BSP_IO_LEVEL_LOW)){
        boton = 0;
