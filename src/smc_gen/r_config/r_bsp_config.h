...
#define BSP_CFG_OFS1_REG_VALUE  (0xFFFFCFFF) /* Generated value. Do not edit this manually */
...
/* Version number of Smart Configurator.
   ...
   v1.1.0  : 1010
*/
#define BSP_CFG_CONFIGURATOR_VERSION (1020) /* Generated value. Do not edit this manually */

/* API function disable(R_BSP_StartClock, R_BSP_StopClock)
 0 : Enable API functions
 1 : Disable API functions
*/
#define BSP_CFG_CLOCK_OPERATION_API_FUNCTIONS (1)

/* API function disable(R_BSP_ChangeICLKClockSetting)
 0 : Enable API functions
 1 : Disable API functions
*/
#define BSP_CFG_CHANGE_CLOCK_SETTING_API_FUNCTIONS (1)
...
*/
#define BSP_CFG_INTERRUPT_SETTING_API_FUNCTIONS (1)
...
/* System Clock Division Control Register (SCKDIVCR)
 ...
 6 : x 1/64
*/
#define BSP_CFG_ICLK_DIV (0) /* Generated value. Do not edit this manually */
...
/* System Clock Division Control Register (SCKDIVCR)
 ...
 6 : x 1/64
*/
#define BSP_CFG_PCLKB_DIV (0) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_CLOCK_SOURCE_SEL (0) /* Generated value. Do not edit this manually */

/* External Clock Input Control Register (MOSCCR)
 0 : Stop
 1 : Operate
*/
#define BSP_CFG_EXTCLK_OPERATION (0) /* Generated value. Do not edit this manually */
...
/* Sub-Clock Oscillator Mode Control Register (SOMCR)
 ...
 3 : Low Power Mode 3
*/
#define BSP_CFG_SUBCLK_MODE (0) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_SUBCLK_MARGIN (0) /* Generated value. Do not edit this manually */

/* Low-Speed On-Chip Oscillator Control Register (LOCOCR)
 0 : Stop
 1 : Operate
*/
#define BSP_CFG_LOCO_OPERATION (0) /* Generated value. Do not edit this manually */

/* High-Speed On-Chip Oscillator Control Register (HOCOCR)
 0 : Stop
 1 : Operate
*/
#define BSP_CFG_HOCO_OPERATION (1) /* Generated value. Do not edit this manually */
...
/* Clock Out Control Register (CKOCR)
 ...
 4 : Sub-clock oscillator (SOSC)
*/
#define BSP_CFG_CLKOUT_SEL (0) /* Generated value. Do not edit this manually */
...
/* Clock Out Control Register (CKOCR)
 ...
 7 : x 1/128
*/
#define BSP_CFG_CLKOUT_DIV (2) /* Generated value. Do not edit this manually */
...
/* Clock Out Control Register (CKOCR)
 ...
 1 : Enable
*/
#define BSP_CFG_CLKOUT_ENABLE (0) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_SUBCLK_SEL (0) /* Generated value. Do not edit this manually */

/* Input clock frequency in Hz (EXTAL). */
#define BSP_CFG_EXTAL_HZ (20000000) /* Generated value. Do not edit this manually */

/* Input clock frequency in Hz (JTAG). */
#define BSP_CFG_EXTCLK_INPUT_JTAG_HZ (6250000) /* Generated value. Do not edit this manually */
...
/* Operation Power Mode Select (OPCCR register and SOPCCR register)
 ...
 3: Low-speed mode 
 */
#define BSP_CFG_OPERATION_MODE (0) /* Generated value. Do not edit this manually */
...
/* Counter value higher or lower in machine timer */
#define BSP_CFG_MTIME_COUNTER_HIGHERBITS (0x00000000)
#define BSP_CFG_MTIME_COUNTER_LOWERBITS (0x00000000)

/* Compare value higher or lower in machine timer */
#define BSP_CFG_MTIME_COMPARE_HIGHERBITS (0xFFFFFFFF)
#define BSP_CFG_MTIME_COMPARE_LOWERBITS (0xFFFFFFFF)
