...
#define BSP_CFG_MTIME_COUNTER_HIGHERBITS (0x0000)
#define BSP_CFG_MTIME_COUNTER_LOWERBITS (0x0000)

/* Compare value higher or lower in machine timer */
#define BSP_CFG_MTIME_COMPARE_HIGHERBITS (0xFFFF)
#define BSP_CFG_MTIME_COMPARE_LOWERBITS (0xFFFF)
