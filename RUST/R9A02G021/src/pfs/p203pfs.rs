#[doc = "Register `P203PFS` reader"]
pub type R = crate::R<P203pfsSpec>;
#[doc = "Register `P203PFS` writer"]
pub type W = crate::W<P203pfsSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P203pfsSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P203pfsSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P203pfsSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open-Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P203pfsSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bits 10:11 - Port Output Current Control"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P203pfsSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Event on Falling (EOF)/Event on Rising (EOR)"]
    #[inline(always)]
    pub fn eofr(&mut self) -> EofrW<P203pfsSpec> {
        EofrW::new(self, 12)
    }
    #[doc = "Bit 14 - IRQ Input Enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P203pfsSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input Enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P203pfsSpec> {
        AselW::new(self, 15)
    }
    #[doc = "Bit 16 - Port Mode Control"]
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P203pfsSpec> {
        PmrW::new(self, 16)
    }
    #[doc = "Bits 24:28 - Peripheral Select"]
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P203pfsSpec> {
        PselW::new(self, 24)
    }
}
#[doc = "Port 203 Pin Function Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p203pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p203pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P203pfsSpec;
impl crate::RegisterSpec for P203pfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p203pfs::R`](R) reader structure"]
impl crate::Readable for P203pfsSpec {}
#[doc = "`write(|w| ..)` method takes [`p203pfs::W`](W) writer structure"]
impl crate::Writable for P203pfsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P203PFS to value 0x10"]
impl crate::Resettable for P203pfsSpec {
