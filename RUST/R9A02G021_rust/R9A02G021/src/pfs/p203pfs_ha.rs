#[doc = "Register `P203PFS_HA` reader"]
pub type R = crate::R<P203pfsHaSpec>;
#[doc = "Register `P203PFS_HA` writer"]
pub type W = crate::W<P203pfsHaSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P203pfsHaSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P203pfsHaSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P203pfsHaSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open-Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P203pfsHaSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bits 10:11 - Port Output Current Control"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P203pfsHaSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Event on Falling (EOF)/Event on Rising (EOR)"]
    #[inline(always)]
    pub fn eofr(&mut self) -> EofrW<P203pfsHaSpec> {
        EofrW::new(self, 12)
    }
    #[doc = "Bit 14 - IRQ Input Enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P203pfsHaSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input Enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P203pfsHaSpec> {
        AselW::new(self, 15)
    }
}
#[doc = "Port 203 Pin Function Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p203pfs_ha::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p203pfs_ha::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P203pfsHaSpec;
impl crate::RegisterSpec for P203pfsHaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p203pfs_ha::R`](R) reader structure"]
impl crate::Readable for P203pfsHaSpec {}
#[doc = "`write(|w| ..)` method takes [`p203pfs_ha::W`](W) writer structure"]
impl crate::Writable for P203pfsHaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets P203PFS_HA to value 0x10"]
impl crate::Resettable for P203pfsHaSpec {
