#[doc = "Register `P00%sPFS` reader"]
pub type R = crate::R<P00pfsSpec>;
#[doc = "Register `P00%sPFS` writer"]
pub type W = crate::W<P00pfsSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<P00pfsSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<P00pfsSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<P00pfsSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open-Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<P00pfsSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bits 10:11 - Port Output Current Control"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<P00pfsSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bits 12:13 - Event on Falling (EOF)/Event on Rising (EOR)"]
    #[inline(always)]
    pub fn eofr(&mut self) -> EofrW<P00pfsSpec> {
        EofrW::new(self, 12)
    }
    #[doc = "Bit 14 - IRQ Input Enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<P00pfsSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input Enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<P00pfsSpec> {
        AselW::new(self, 15)
    }
    #[doc = "Bit 16 - Port Mode Control"]
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<P00pfsSpec> {
        PmrW::new(self, 16)
    }
    #[doc = "Bits 24:28 - Peripheral Select"]
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<P00pfsSpec> {
        PselW::new(self, 24)
    }
}
#[doc = "Port 00%s Pin Function Select Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p00pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p00pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P00pfsSpec;
impl crate::RegisterSpec for P00pfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p00pfs::R`](R) reader structure"]
impl crate::Readable for P00pfsSpec {}
#[doc = "`write(|w| ..)` method takes [`p00pfs::W`](W) writer structure"]
impl crate::Writable for P00pfsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets P00%sPFS to value 0"]
impl crate::Resettable for P00pfsSpec {
