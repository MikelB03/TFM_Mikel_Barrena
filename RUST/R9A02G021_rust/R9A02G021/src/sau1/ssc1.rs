#[doc = "Register `SSC1` reader"]
pub type R = crate::R<Ssc1Spec>;
#[doc = "Register `SSC1` writer"]
pub type W = crate::W<Ssc1Spec>;
...
impl W {
    #[doc = "Bit 0 - Setting of the Snooze mode"]
    #[inline(always)]
    pub fn swc(&mut self) -> SwcW<Ssc1Spec> {
        SwcW::new(self, 0)
    }
    #[doc = "Bit 1 - Selection of whether to enable or disable the generation of communication error interrupts in the Snooze mode"]
    #[inline(always)]
    pub fn ssec(&mut self) -> SsecW<Ssc1Spec> {
        SsecW::new(self, 1)
    }
}
#[doc = "Serial Standby Control Register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`ssc1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ssc1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ssc1Spec;
impl crate::RegisterSpec for Ssc1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`ssc1::R`](R) reader structure"]
impl crate::Readable for Ssc1Spec {}
#[doc = "`write(|w| ..)` method takes [`ssc1::W`](W) writer structure"]
impl crate::Writable for Ssc1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets SSC1 to value 0"]
impl crate::Resettable for Ssc1Spec {
